...
CHANGE_TRACK_NUMBER = False # Enabling this will change the Track number property to match the order of the playlist, you can use this to sort in your music player
